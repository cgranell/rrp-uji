...
-   .large[Document the process such as simple steps and diagrams in a README file (See [\#7](#basic7))]
...
1.    .large[[One project = One folder](#basic1)]

1.    .large[[Choose your best way to organise a folder](#basic2)]

1.    .large[[Choose a consistent file naming convention](#basic3)]

1.    .large[[Never ever touch raw data](#basic4)]

1.    .large[[Use open data formats](#basic5)]

1.    .large[[Avoid "Data (or code) available upon request"](#basic6)]

1.    .large[[Document, document, document](#basic7)]

1.    .large[[Add a data license](#basic8)]

1.    .large[[Add a software license](#basic9)]

1.    .large[[Report the software version you use](#basic10)]

1.    .large[[Cite the software you use](#basic11)]
