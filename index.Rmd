...
This web site is the main resource of the course. In the top menu, `General Information` menu item allows you to consult the [code of conduct](code of conduct.html) and the [course schedule](schedule.html). If you read Spanish, you can continue reading the [blog posts](blog.html). The `Resources` menu item provides you with additional documents and materials to go deeper into this topic. As we progress through the course, the teaching materials are available from the `Sessions` menu item.
