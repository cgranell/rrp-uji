...
3.  Reflect on the extent to which these terms ([reproduction, replication, robustness, generalisation](https://the-turing-way.netlify.app/reproducible-research/overview/overview-definitions.html)) [@turingway2019] are widespread in your own discipline or area of research. Which is more predominant in your discipline? And in your research? Of the journals you publish (or flag-ship journals in your discipline,) do they request articles that support computational reproducibility, 
empirical reproducibility, or statistical reproducibility?


4.  (Optional) If you're still hesitant to embrace reproducibility, [Five Selfish Reasons to Work Reproducibly by Dr. Florian Markowetz](https://www.youtube.com/watch?v=yVT07Sukv9Q)], based his paper [@markowetz2015], will convince you!
...
-   Write a message (min 150 words) to answer the questions posed in Activity 3 above to the forum  **Reflection on reproducibility/replicability in your discipline and in your own researchForo** in AV. Please, indicate in the message your discipline or area of knowledge.
