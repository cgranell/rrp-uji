...
-   Scene 2: [Reproducibilidty assessment criteria](session12.html)

## Act II: Recommendations and practices

We cover learning outcomes [RRP05 to RRP07](index.html#learning-outcomes).

-   Scene 1: [Basics to get started](session21.html)

-   Scene 2: [More recommendations](session21.html)

## Act III: Literate programming y notebooks

We cover learning outcomes [RRP08 to RRP09](index.html#learning-outcomes).

-   Scene 1: [Literate programming y markdown](sesion31.html)

-   Scene 2: [R Markdown Notebooks](sesion32.html)
